...
{
		HX_STACK_FRAME("com.sdl.Sdl","Log",0x94c8f8b1,"com.sdl.Sdl.Log","com/sdl/Sdl.hx",113,0xc5861965)
		HX_STACK_ARG(str,"str")
		HX_STACK_LINE(113)
		::com::sdl::Sdl_obj::hx_log(str);
	}
return null();
}
...
Void Sdl_obj::Quit( ){
{
		HX_STACK_FRAME("com.sdl.Sdl","Quit",0x9e634302,"com.sdl.Sdl.Quit","com/sdl/Sdl.hx",117,0xc5861965)
		HX_STACK_LINE(117)
		::com::sdl::Sdl_obj::hx_quit();
	}
return null();
}
...
int Sdl_obj::GetTicks( ){
	HX_STACK_FRAME("com.sdl.Sdl","GetTicks",0x750b56b3,"com.sdl.Sdl.GetTicks","com/sdl/Sdl.hx",122,0xc5861965)
	HX_STACK_LINE(122)
	return ::com::sdl::Sdl_obj::hx_GetTicks();
}
...
int Sdl_obj::mouseX( ){
	HX_STACK_FRAME("com.sdl.Sdl","mouseX",0x35804c66,"com.sdl.Sdl.mouseX","com/sdl/Sdl.hx",127,0xc5861965)
	HX_STACK_LINE(127)
	return ::com::sdl::Sdl_obj::hx_EventMouseX();
}
...
int Sdl_obj::mouseY( ){
	HX_STACK_FRAME("com.sdl.Sdl","mouseY",0x35804c67,"com.sdl.Sdl.mouseY","com/sdl/Sdl.hx",131,0xc5861965)
	HX_STACK_LINE(131)
	return ::com::sdl::Sdl_obj::hx_EventMouseY();
}
...
Float Sdl_obj::fingerX( ){
	HX_STACK_FRAME("com.sdl.Sdl","fingerX",0x01cb9b5c,"com.sdl.Sdl.fingerX","com/sdl/Sdl.hx",136,0xc5861965)
	HX_STACK_LINE(136)
	return ::com::sdl::Sdl_obj::hx_EventFingerX();
}
...
Float Sdl_obj::fingerY( ){
	HX_STACK_FRAME("com.sdl.Sdl","fingerY",0x01cb9b5d,"com.sdl.Sdl.fingerY","com/sdl/Sdl.hx",140,0xc5861965)
	HX_STACK_LINE(140)
	return ::com::sdl::Sdl_obj::hx_EventFingerY();
}
...
int Sdl_obj::touchX( ){
	HX_STACK_FRAME("com.sdl.Sdl","touchX",0x01f3b18c,"com.sdl.Sdl.touchX","com/sdl/Sdl.hx",149,0xc5861965)
	HX_STACK_LINE(149)
	return ::com::sdl::Sdl_obj::hx_EventMouseX();
}
...
int Sdl_obj::touchY( ){
	HX_STACK_FRAME("com.sdl.Sdl","touchY",0x01f3b18d,"com.sdl.Sdl.touchY","com/sdl/Sdl.hx",158,0xc5861965)
	HX_STACK_LINE(158)
	return ::com::sdl::Sdl_obj::hx_EventMouseY();
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.sdl.Sdl"), hx::TCanCast< Sdl_obj> ,sStaticFields,sMemberFields,
