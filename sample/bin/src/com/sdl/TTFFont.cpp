...
{
HX_STACK_FRAME("com.sdl.TTFFont","new",0x4fb2bac7,"com.sdl.TTFFont.new","com/sdl/TTFFont.hx",12,0x7d87058b)
HX_STACK_THIS(this)
HX_STACK_ARG(filename,"filename")
HX_STACK_ARG(size,"size")
{
	HX_STACK_LINE(13)
	Dynamic _g = ::com::sdl::Sdl_obj::hx_LoadFont(filename,size);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(13)
	this->handle = _g;
}
;
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.sdl.TTFFont"), hx::TCanCast< TTFFont_obj> ,sStaticFields,sMemberFields,
