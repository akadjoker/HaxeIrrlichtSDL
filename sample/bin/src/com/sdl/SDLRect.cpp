...
{
HX_STACK_FRAME("com.sdl.SDLRect","new",0x646f0571,"com.sdl.SDLRect.new","com/sdl/SDLRect.hx",15,0x835c3e21)
HX_STACK_THIS(this)
...
int w = __o_w.Default(1);
int h = __o_h.Default(1);
	HX_STACK_FRAME("com.sdl.SDLRect","set",0x6472d0b3,"com.sdl.SDLRect.set","com/sdl/SDLRect.hx",23,0x835c3e21)
	HX_STACK_THIS(this)
	HX_STACK_ARG(x,"x")
	HX_STACK_ARG(y,"y")
	HX_STACK_ARG(w,"w")
...
Void SDLRect_obj::copy( ::com::sdl::SDLRect r){
{
		HX_STACK_FRAME("com.sdl.SDLRect","copy",0x7577f584,"com.sdl.SDLRect.copy","com/sdl/SDLRect.hx",31,0x835c3e21)
		HX_STACK_THIS(this)
		HX_STACK_ARG(r,"r")
		HX_STACK_LINE(32)
		this->x = r->x;
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.sdl.SDLRect"), hx::TCanCast< SDLRect_obj> ,sStaticFields,sMemberFields,
