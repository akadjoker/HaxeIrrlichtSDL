...
{
HX_STACK_FRAME("com.sdl.SDL_Point","new",0xe41916de,"com.sdl.SDL_Point.new","com/sdl/SDL_Point.hx",12,0xb5103dd4)
HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.sdl.SDL_Point"), hx::TCanCast< SDL_Point_obj> ,sStaticFields,sMemberFields,
