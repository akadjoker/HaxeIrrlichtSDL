...
int Sdl_obj::touchX( ){
	HX_STACK_FRAME("sdl.Sdl","touchX",0x88de0bff,"sdl.Sdl.touchX","sdl/Sdl.hx",149,0x96b11317)
	HX_STACK_LINE(149)
	return ::sdl::Sdl_obj::hx_EventMouseX();
}
...
int Sdl_obj::touchY( ){
	HX_STACK_FRAME("sdl.Sdl","touchY",0x88de0c00,"sdl.Sdl.touchY","sdl/Sdl.hx",158,0x96b11317)
	HX_STACK_LINE(158)
	return ::sdl::Sdl_obj::hx_EventMouseY();
}
...
Dynamic Sdl_obj::sdl_startIrrlciht;

Dynamic Sdl_obj::sdl_renderIrrlciht;
...
Dynamic Sdl_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 17:
		...
		if (HX_FIELD_EQ(inName,"sdl_startIrrlciht") ) { return sdl_startIrrlciht; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"hx_DestroyRenderer") ) { return hx_DestroyRenderer; }
		if (HX_FIELD_EQ(inName,"sdl_renderIrrlciht") ) { return sdl_renderIrrlciht; }
		break;
	case 19:
...
Dynamic Sdl_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 17:
		...
		if (HX_FIELD_EQ(inName,"sdl_startIrrlciht") ) { sdl_startIrrlciht=inValue.Cast< Dynamic >(); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"hx_DestroyRenderer") ) { hx_DestroyRenderer=inValue.Cast< Dynamic >(); return inValue; }
		if (HX_FIELD_EQ(inName,"sdl_renderIrrlciht") ) { sdl_renderIrrlciht=inValue.Cast< Dynamic >(); return inValue; }
		break;
	case 19:
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("sdl_startIrrlciht"),
	HX_CSTRING("sdl_renderIrrlciht"),
	String(null()) };
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Sdl_obj::sdl_startIrrlciht,"sdl_startIrrlciht");
	HX_MARK_MEMBER_NAME(Sdl_obj::sdl_renderIrrlciht,"sdl_renderIrrlciht");
};
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Sdl_obj::sdl_startIrrlciht,"sdl_startIrrlciht");
	HX_VISIT_MEMBER_NAME(Sdl_obj::sdl_renderIrrlciht,"sdl_renderIrrlciht");
};
...
void Sdl_obj::__boot()
{
	...
	sdl_startIrrlciht= ::cpp::Lib_obj::load(HX_CSTRING("sdlhaxe"),HX_CSTRING("sdl_startIrrlciht"),(int)0);
	sdl_renderIrrlciht= ::cpp::Lib_obj::load(HX_CSTRING("sdlhaxe"),HX_CSTRING("sdl_renderIrrlciht"),(int)0);
}
