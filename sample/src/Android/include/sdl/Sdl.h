...
class HXCPP_CLASS_ATTRIBUTES  Sdl_obj : public hx::Object{
	...
	public:
		...
		static Dynamic sdl_startIrrlciht;
		static Dynamic &sdl_startIrrlciht_dyn() { return sdl_startIrrlciht;}
		static Dynamic sdl_renderIrrlciht;
		static Dynamic &sdl_renderIrrlciht_dyn() { return sdl_renderIrrlciht;}
};
